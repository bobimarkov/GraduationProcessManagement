...
<body>
    ...
    <div class="row">
        ...
        <div id="users_section">
            ...
            <form id="add_users_form" name="new_user_form" onsubmit="return false">
                <textarea class="form-input" name="userTextarea" id="userTextarea" rows="30"
                    placeholder="Формат: &NewLine;&quot;имейл, парола, имена, телефон, роля&quot;&NewLine;&NewLine;роля=[admin, moderator]"></textarea>
                <button type="submit" id="submit-button-users" class="submit-button-users"
                    onclick="submitUsers(event)">Добави <i class="fas fa-solid fa-plus"></i></button>
            </form>
        </div>
        ...
        <div id="students_section">
            ...
            <h3><i class="fas fa-folder-plus"></i> Въведи нови</h3>
            <form id="import_files" method="post" >
                <label for="filebutton">Избери файл:</label>
                <input type="file" name="file[]" id="file" accept=".txt,.csv" multiple/>
                <input type="submit" class="submit-button" name="import" onclick="submitStudentsFromFile(event)" value="Добави"></input>
            </form>
            <form id="export_files" method="post" action="../../services/export.php">
                <label for="format">Изберете файлов формат:</label>
                ...
                <input type="submit" name="export" class="submit-button" value="Изтегли"></input>
            </form>
            ...
            <form id="add_students_form" name="add_students_form" onsubmit="return false">
                ...
                <button type="submit" id="submit-button-users" class="submit-button-users"
                    onclick="submitStudents(event)">Добави <i class="fas fa-solid fa-plus"></i></button>
            </form>
        </div>
        ...
        <div id="edit_section">
            ...
            <form id="edit_students_form" name="edit_students_form" onsubmit="return false">
                ...
                <button type="submit" id="submit-button-users" class="submit-button-users"
                    onclick="editStudent(event)">Редактирай </button>
            </form>
        </div>
        ...
        <div id="diploma_section">
            ...
            <form class="dashboard" id="dashboard">
                <textarea class="dashboard-textarea-fn" name="dashboard-textarea" id="dashboard_textarea"
                    placeholder="Факуктетни номера (отделени със запетая)"></textarea>
                ...
                <button type="submit" id="submit_action" class="submit-action" onclick="submitAction(event)">Запази <i
    ...
    <div class="row diploma_order_section" id="diploma_order_section">
        ...
        <form id="diploma_order_form">
            <select id="diploma_order_1" name="diploma_order_1" class="diploma_order_select"
                onchange="removeValueFromOtherLists(this)">
            ...
            <button type="submit" id="submit_action" class="submit-action" onclick="submitDiplomaOrder(event)">Запази <i
