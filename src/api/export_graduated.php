...
if ($_SERVER["REQUEST_METHOD"] === 'POST') {
    ...
    if (isset($data["format"])) {
        ...
        if ($format !== 'pdf' && $format !== 'no') {
            ...
            fputcsv($output, array('ФН', 'Име', 'Степен', 'Спец.', 'Група', 'Успех', 'Присъствие', 'Има право', 'Готова', 'Взета', 'Заявка взимане предв.', 'Коментар(студент)', 'Взета предв.', 'Дата/час', 'Коментар(администр.)', 'Покана реч', 'Отговор', 'Снимки', 'Заявена тога', 'Взета', 'Дата/час', 'Върната', 'Дата/час', 'Заявена шапка', 'Взета', 'Дата/час'));
